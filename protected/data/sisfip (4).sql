...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-08-2015 a las 13:57:26
...
(1, 'Jose Luis Ayala Benito', '71886624', 'Umayux group', 'av lima 790', '944659233', 'abcd@gmail.com', 'si referencia alguna', '2015-07-30 04:15:16', '0', '71886624', '71886624'),
...
(9, '2015-08-15 23:46:12', 1, '111', '111       \n         ', '190.00', '0000-00-00', 3, NULL, 'Umayux group', '0'),
...
ALTER TABLE `detalleordentrab`
 ADD KEY `fk_orden_detalle` (`nroOrden`), ADD KEY `fk_serv_detalle` (`idServicio`);
...
--
ALTER TABLE `cotizacion`
MODIFY `idCotizacion` int(11) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=14;
--
...
--
ALTER TABLE `muestra`
MODIFY `idMuestra` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=24;
--
-- AUTO_INCREMENT de la tabla `ordentrabajo`
--
ALTER TABLE `ordentrabajo`
MODIFY `nroOrden` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `detalleordentrab`
ADD CONSTRAINT `fk_orden_detalle` FOREIGN KEY (`nroOrden`) REFERENCES `ordentrabajo` (`nroOrden`),
