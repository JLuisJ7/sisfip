...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-08-2015 a las 13:50:14
...
(43, 41, 'Solicitudes', 'solicitud/solicitudes', 38, '0', '1', 'lalipazaga@sismima.com', NULL, NULL, NULL, NULL, 0),
...
(1, 'Jose Luis Ayala Benito', '71886624', 'Umayux group', 'av lima 790', '944659233', 'abcd@gmail.com', 'si referencia alguna', '2015-07-30 04:15:16', '0', 'Lima', 'Lima'),
...
(1, 12, 'PETROLEO 96', NULL, 'NO', NULL, '264.00'),
...
(25, 1, 'ASD', 'Umayux group', 'ass', 'as', 3, 3, 'SI', '0', 'asss', 'DASSSSS');
...
(1, 12, '0000-00-00', 'dsa', 23, 'sda', 'sadsad', '2015-08-01 00:00:00', 1, '2015-08-17 19:08:24', '0', '0'),
(2, 12, '2015-07-17', '<sd', 23, 'sdf', 'ads\n    ', '2015-08-30 00:00:00', 1, '2015-08-17 19:54:44', '0', '0'),
...
(17, 14, '2015-08-19', 'a', 25, 'ASD', 'DASSSSS', '2015-08-27 00:00:00', 1, '2015-08-20 04:51:51', '0', '0'),
(18, 12, '2015-08-19', 'asd', 23, 'asd', 'adsssss       \n    ', '2015-08-21 00:00:00', 1, '2015-08-20 04:53:50', '0', '0');
...
ALTER TABLE `detalleordentrab`
 ADD KEY `fk_serv_detalle` (`idServicio`), ADD KEY `nroOrden` (`nroOrden`);
...
ALTER TABLE `ordentrabajo`
 ADD PRIMARY KEY (`nroOrden`), ADD KEY `fk_orden_solicitud` (`nroSolicitud`), ADD KEY `fk_orden_muestra` (`idMuestra`);
...
--
ALTER TABLE `admopcion`
MODIFY `ide_opcion` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=50;
--
...
--
ALTER TABLE `admrolopcion`
MODIFY `ide_rolopcion` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=73;
--
...
--
ALTER TABLE `muestra`
MODIFY `idMuestra` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=26;
--
