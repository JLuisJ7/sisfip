...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-08-2015 a las 09:34:49
...
(1, 'Jose Luis Ayala', '71886624', 'Umayux group', 'av lima 790', '944659233', 'abcd@gmail.com', 'si referencia alguna', '2015-07-30 04:15:16', '0', 'Jose Luis Ayala', 'Jose Luis Ayala'),
...
--
ALTER TABLE `admopcion`
MODIFY `ide_opcion` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=44;
--
...
--
ALTER TABLE `admrolopcion`
MODIFY `ide_rolopcion` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=66;
--
...
--
ALTER TABLE `muestra`
MODIFY `idMuestra` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=18;
--
